...
public class JavaVelocityPluginDescriptionCandidate extends VelocityPluginDescription {

  private final String mainClass;

  public JavaVelocityPluginDescriptionCandidate(String id, @Nullable String name, @Nullable String version,
