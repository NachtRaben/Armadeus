...
public class DiscordUser {
    ...
    private static final ShardManager shardManager = Armadeus.getInstance().getShardManager();
    ...
    public GuildConfig getGuildConfig() {
        return guild != null ? Armadeus.getInstance().getGuildManager().getConfigurationFor(guild.resolve()) : null;
    }
