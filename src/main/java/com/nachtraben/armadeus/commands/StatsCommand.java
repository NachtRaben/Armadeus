...
public class StatsCommand extends Command {
    ...
    public void run(CommandSender sender, Map<String, String> args, Map<String, String> flags) {
        ...
        String stats = String.format(StatsCommand.stats,
                ...
                com.nachtraben.armadeus.Armadeus.getInstance().getShardManager().getTextChannels().size(),
                com.nachtraben.armadeus.Armadeus.getInstance().getShardManager().getVoiceChannels().size(),
                com.nachtraben.armadeus.Armadeus.getInstance().getShardManager().getPrivateChannels().size(),
                com.nachtraben.armadeus.Armadeus.getInstance().getLavalink().getLinks().stream().filter(link -> link.getChannel() != null).count(),
                com.nachtraben.armadeus.Armadeus.getInstance().getShardManager().getGuilds().size(),
