...
public class AboutCommand extends Command {
    ...
    public void run(CommandSender sender, Map<String, String> args, Map<String, String> flags) {
        if (sender instanceof DiscordCommandSender) {
            ...
            builder.setAuthor(bot.getName(), "https://Armadeusbot.com", bot.getAvatarUrl());
            ...
            if(sendee instanceof GuildCommandSender) {
                ...
                GuildConfig config = com.nachtraben.armadeus.Armadeus.getInstance().getGuildManager().getConfigurationFor(sendeee.getGuild().getIdLong());
                if(!config.getPrefixes().isEmpty())
                    sb.append(config.getPrefixes());
                else
                    sb.append(Armadeus.getInstance().getConfig().getPrefixes());
            } else {
                sb.append(com.nachtraben.armadeus.Armadeus.getInstance().getConfig().getPrefixes());
            }
            sb.append("`");
